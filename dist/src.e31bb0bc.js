...
function createElement() {
  return _app.galleryItems.map(function (_ref, index) {
...
function onArrowLeft() {
  ...
  if (index === 0) {
    step(_app.galleryItems.length - 1);
    return;
  }
...
function onArrowRight() {
  ...
  if (index === _app.galleryItems.length - 1) {
    step(0);
    return;
  }
...
function step(index) {
  ...
  refs.lightboxImage.src = _app.galleryItems[index + step].original;
}
